...
class RewardVisualizer(Node):
    ...
    def __init__(self, print_interval=10):
        ...
        self.min_values = {'continuous': 0, 'wall': 0, 'exploration': 0, 'movement': 0, 'total': 0}
        self.max_values = {'continuous': 0, 'wall': 0, 'exploration': 0, 'movement': 0, 'total': 0}

        self.get_logger().info("Corrected reward tracker initialized")

    def add_reward_data(self, continuous, wall, exploration, movement, total):
        """
        ...
        calculated_total = continuous + wall + exploration + movement
        ...
        self.cum_total_reward += calculated_total  # Use calculated total to ensure consistency
        ...
        self.recent_values['total'].append(calculated_total)  # Use calculated total
        ...
        self._update_min_max('total', calculated_total)
    ...
    def reset_data(self):
        ...
        self.cum_exploration_reward = 0.0  # Make sure this is set to 0!
