...
class RawDataHandler:
    ...
    def calc_map_center(self, origin_x, origin_y, width, height, resolution, odom_ready, pos, slam_pose):
        center_cell_x = 0
        center_cell_y = 0
    ...
    def crop_map(self, data_map, width, height, resolution, center_cell_x, center_cell_y):
        """Process SLAM map data by cropping a 6m x 6m area centered on the robot's starting position"""

        crop_size_cells, max_x, max_y, min_x, min_y = self.calc_map_range(center_cell_x, center_cell_y, height, resolution, width)
    ...
    def calc_map_range(self, center_cell_x, center_cell_y, height, resolution, width):
